...
local inline = {{{text="قنآهہ‏‏ آلسـورس : كيوبالي 🍃",url="t.me/vpsbots"}}}
return send_inline_key(msg.from.id,'  [قناة السورس : كيوبالي](t.me/vpsbots)',nil,inline)
end
